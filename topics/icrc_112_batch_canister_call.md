...
| 1003 | Validation failed                          | The request was executed, but validation call returned false response, indicating that the validatin failed.                          | (optional) Error details: <ul> <li>`message` (`text`, optional): message</li> </ul> |
