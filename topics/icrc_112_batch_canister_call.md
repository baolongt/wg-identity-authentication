...
| 1003 | Validation failed                          | The request was executed, but validation call returned fail response.                          | (optional) Error details: <ul> <li>`message` (`text`, optional): message</li> </ul> |
